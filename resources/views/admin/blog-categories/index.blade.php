                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td class="px-6 py-4 flex justify-end space-x-2">
                                        <a href="{{ route('admin.blog-categories.edit', $category) }}" title="Edit" class="inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 shadow-sm">
                                            <i class="bi bi-pencil-square me-1"></i> Edit
                                        </a>
                                        <form action="{{ route('admin.blog-categories.destroy', $category) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus kategori ini? Postingan terkait tidak akan terhapus, hanya kategorinya saja yg hilang.');">
                                            @csrf
                                            @method('DELETE')
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400 italic">Belum ada data kategori blog.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
