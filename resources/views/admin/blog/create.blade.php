                    ...
                    <div class="p-6 lg:p-8 text-gray-900 dark:text-gray-100 space-y-6">
                        ...
                        <div class="block">
                            <label for="is_published" class="inline-flex items-center">
                                <input id="is_published" name="is_published" type="checkbox" value="1" {{ old('is_published', true) ? 'checked' : '' }} class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm">
