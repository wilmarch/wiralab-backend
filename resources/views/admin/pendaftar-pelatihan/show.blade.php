    ...
    <div class="py-4 sm:py-6">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8"> 
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl sm:rounded-xl overflow-hidden">
                ...
                {{-- HEADER AKSI (Tombol Kembali SAJA) --}}
                <div class="px-5 py-3 bg-gray-50 dark:bg-gray-700 flex justify-start items-center border-b border-gray-200 dark:border-gray-600">
                    <a href="{{ route('admin.pendaftar-pelatihan.index') }}" 
                       class="inline-flex items-center px-3 py-1.5 bg-gray-600 border border-transparent rounded-lg text-xs font-semibold text-white shadow-sm hover:bg-gray-700 transition duration-150">
                        <i class="bi bi-arrow-left me-2"></i> Kembali ke Daftar
                    </a>
                    
                    {{-- Form Hapus Data Pendaftar (DIHAPUS DARI SINI) --}}
                </div>
                ...
                <div class="p-5 md:p-6">
                    ...
                    <dl class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700 overflow-hidden">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0 font-medium">
                                <a href="mailto:{{ $pendaftar_pelatihan->email }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">
                                    <i class="bi bi-envelope-fill me-1 text-blue-500"></i> {{ $pendaftar_pelatihan->email }}
                                </a>
                            </dd>
                        </div>
                        ...
                        {{-- Telepon (LINK TEL & WA) --}}
                        <div class="bg-white dark:bg-gray-800 px-4 py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">TELEPON</Tdt>
                    ...
                    <section class="mt-8 pt-6 border-t dark:border-gray-700">
                        <h4 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Pesan Tambahan</h4>
                        <div class="text-gray-700 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-700 p-5 rounded-lg shadow-inner border border-gray-200 dark:border-gray-600">
                            {{-- Karena tidak ada kolom body, kita ganti dengan pesan standar --}}
                            <p class="text-gray-500 dark:text-gray-400 italic">Tidak ada pesan tambahan yang dikirim oleh pendaftar ini.</p>
                        </div>
                    </section>
                </div>
            </div>
