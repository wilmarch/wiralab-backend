                ...
                <form method="POST" action="{{ route('admin.careers.update', $karir) }}">
                    ...
                    <div class="p-6 lg:p-8 text-gray-900 dark:text-gray-100 space-y-6">
                        ...
                        <div>
                            ...
                            <input id="description" type="hidden" name="description" value="{{ old('description', $karir->description) }}">
                        ...
                        <div>
                            ...
                            <input id="requirements" type="hidden" name="requirements" value="{{ old('requirements', $karir->requirements) }}">
                            <trix-editor input="requirements" class="trix-content block w-full mt-1 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"></trix-editor>
